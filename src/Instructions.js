...
function Instructions() {
  return (
    <section className="instructions">
      ...
      <ol>
        <li>
          <span className="bold">Beat the eggs:</span> In a bowl, beat the eggs
        ...
        <li>
          <span className="bold">Heat the pan:</span> Place a non-stick frying
          pan over medium heat and add butter or oil.
        </li>
        <li>
          <span className="bold">Cook the omelette:</span> Once the butter is
          melted and bubbling, pour in the eggs. Tilt the pan to ensure the eggs
          evenly coat the surface.
        </li>
        <li>
          <span className="bold">Add fillings (optional):</span> When the eggs
        ...
        <li>
          <span className="bold">Enjoy:</span> Serve hot, with additional salt
